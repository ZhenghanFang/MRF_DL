...
parser.add_argument('--saved_model_path', type=str, default='/Users/zhenghanfang/raid/zhenghan/checkpoints/MRF_simu/simu_ar4_load20/final_net_G_A.pth', help='path of model')
...
opt.isTrain = False
opt.name = os.path.basename(os.path.dirname(opt.saved_model_path))
opt.results_dir = os.path.join(os.path.dirname(opt.saved_model_path), opt.name + '_test')
args = vars(opt)
print('------------ Options -------------')
