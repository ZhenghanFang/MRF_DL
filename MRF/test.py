...
parser.add_argument('--onMAC', action='store_false', default=True, help='Run on iMAC')
parser.add_argument('--onMAC', dest='onMAC', action='store_true', help='Run on iMAC')
parser.add_argument('--not-onMAC', dest='onMAC', action='store_false', help='Not run on iMAC')
parser.set_defaults(onMAC=True)
