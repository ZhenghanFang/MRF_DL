...
parser.add_argument('--name', type=str, default='Uni_46_patch128_ar4', help='name of the experiment. It decides where to store samples and models')
...
parser.add_argument('--patchSize', type=int, default=128, help='patch length & width')
...
parser.add_argument('--which_model_netG', type=str, default='UniNet', help='selects model to use for netG')
...
for epoch in range(opt.epoch_count, opt.niter + opt.niter_decay + 1):
    ...
    elif opt.dataset == 'highres_dataset' or opt.dataset == 'simulated_dataset' or opt.dataset == 'dict_dataset' or opt.dataset == 'single_dataset_2':
