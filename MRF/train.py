...
for epoch in range(opt.epoch_count, opt.niter + opt.niter_decay + 1):
    ...
    elif opt.dataset == 'highres_dataset' or opt.dataset == 'simulated_dataset' or opt.dataset == 'dict_dataset' or opt.dataset == 'single_dataset_2' or opt.dataset == 'T1hT2_dataset':
